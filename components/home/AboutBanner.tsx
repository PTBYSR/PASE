...
const AboutBanner = () => {
  return (
    <section id="about" className='bg-midnight py-24 px-14'>
      <div className='flex h-[500px] w-full flex-row-reverse gap-10'>
        <div className=' w-1/3'>
          <h2 className='space uppercase text-gray leading-[6rem] text-5xl font-bold'> who are we<span className="text-gum">?</span></h2>
        </div>
